...
NIFTY200_WATCHLIST: List[str] = sorted(list(set(NIFTY100_WATCHLIST + [
    "AARTIIND", "ABCAPITAL", "ABFRL", "ADANIENSOL", "ADANIGREEN", "ADANIPOWER", "ASHOKLEY", "AUBANK", 
    "AUROPHARMA", "BALKRISIND", "BANDHANBNK", "BERGEPAINT", "BHARATFORG", "BIOCON", "CANFINHOME", 
    "CHOLAFIN", "COFORGE", "COLPAL", "CONCOR", "CUMMINSIND", "DALBHARAT", "DEEPAKNTR", "DELHIVERY", 
    "ESCORTS", "EXIDEIND", "FEDERALBNK", "FORTIS", "GLENMARK", "GMRINFRA", "HAL", "HAVELLS", "HDFCAMC", 
    "IDFCFIRSTB", "IEX", "IGL", "INDHOTEL", "INDUSINDBK", "IPCALAB", "JKCEMENT", "JINDALSTEL", "JUBLFOOD", 
    "L&TFH", "LAURUSLABS", "LICHSGFIN", "LTIM", "LUPIN", "M&MFIN", "MANAPPURAM", "MFSL", "MGL", "MPHASIS", 
    "MRF", "MUTHOOTFIN", "NMDC", "OBEROIRLTY", "OFSS", "PAGEIND", "PEL", "PERSISTENT", "PETRONET", "POLYCAB", 
    "RECLTD", "RVNL", "SYNGENE", "TATACOMM", "TATAMTRDVR", "TATAPOWER", "TRENT", "TVSMOTOR", "UBL", 
    "UNITDSPR", "VOLTAS", "YESBANK", "ZEEL"
])))

WATCHLIST_MODE: str = os.getenv("WATCHLIST_MODE", "custom").strip().lower()
WATCHLIST: List[str]
if WATCHLIST_MODE == "nifty200":
    WATCHLIST = NIFTY200_WATCHLIST
elif WATCHLIST_MODE == "nifty100":
