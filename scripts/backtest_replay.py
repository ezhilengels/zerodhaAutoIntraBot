...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--strategy",
        default="multi",
        choices=["pullback", "orb", "vwap_reclaim", "vwap_reclaim_v2", "vwap_rsi", "vwap_rsi_v2", "vwap_rsi_v3", "vwap_rsi_v4", "pivot_breakout", "pivot_breakout_v2", "ema_crossover", "short_intraday_v1", "short_intraday_v2", "short_intraday_v3", "short_intraday_v4", "ath_reversal_v5", "multi"],
